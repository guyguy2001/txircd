...
info-elines           | Allows an oper to view STATS/XINFO topic ELINES.
info-klines           | Allows an oper to view STATS/XINFO topic KLINES.
info-glines           | Allows an oper to view STATS/XINFO topic GLINES.
info-qlines           | Allows an oper to view STATS/XINFO topic QLINES.
info-zlines           | Allows an oper to view STATS/XINFO topic ZLINES.
...
info-shuns                | ShunCommand               | Allows an oper to view STATS/XINFO topic SHUNS.
